...
export default function Button({ type, text, children, ...props }) {
  return (
    <button
      ...
      } ${type === "success" && "text-green-500 border border-green-600 hover:bg-green-500 hover:text-white"} ${
        type === "primary" && "hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 border dark:border-gray-600 dark:hover:bg-gray-900 dark:hover:text-white"
      }`}
    >
