...
export default function Spinner() {
  ...
  return (
    <div className='flex items-center justify-center h-screen bg-gray-900 bg-opacity-75 select-none'>
      ...
      <span className='text-gray-300 dark:text-white'>{t("LOADING")}</span>
    </div>
  );
}
